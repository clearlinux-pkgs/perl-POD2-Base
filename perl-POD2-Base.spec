...
mkdir -p %{_topdir}/BUILD/POD2-Base-0.043/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/POD2-Base-0.043/deblicense/
...
/usr/lib/perl5/site_perl/5.26.1/POD2/PT/POD2/Base.pod
